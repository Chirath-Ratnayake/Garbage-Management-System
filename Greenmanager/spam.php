    ...
    <nav class="col-md-2 d-none d-md-block bg-light sidebar">
      <div class="sidebar-sticky">
          <ul class="nav flex-column">
              ...
              <li class="nav-item">
                  <a class="nav-link active" href="spam.php">
                      <span data-feather="file"></span>
                      Spam Report
                  </a>
              </li>
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
      ...
      <div class="table-responsive">
        <table class="table table-striped table-sm">
          ...
          $query=$db->query("SELECT * FROM reports INNER JOIN users ON users.U_ID=reports.Upload_U_ID WHERE Manager_ID='$U_ID' && Post_Status='2' ORDER by R_ID DESC ");
          while ($query_run=$query->fetch_assoc()){
              ...
              <tr>
                  ...
                  <td><?php echo $query_run['Post_Date'];?></td>
                      ...
                      <td><form action="delete/deletereport.php?R_ID=<?php echo $R_ID;?>&&img=<?php echo $query_run['R_URL'];;?>" method="post">
