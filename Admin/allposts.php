      ...
      <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
          ...
          <div class="table-responsive">
              <table class="table table-striped table-sm">
                  ...
                  $query=$db->query("SELECT * FROM blog INNER JOIN users ON users.U_ID=blog.Added_ID ORDER by Blog_ID DESC");
                  while ($query_run=$query->fetch_assoc()){
                      ?>
                      <tr>
                          <td><?php echo $Blog_ID=$query_run['Blog_ID'];?></td>
                          <td><?php echo $query_run['Blog_Title'];?></td>
                          <td><?php echo $query_run['Date'];?></td>
                          <td><?php echo $query_run['F_Name']." ".$query_run['L_Name'];?></td>
                          <td><form action="viewblogpost.php?Blog_ID=<?php echo $Blog_ID;?>" method="post">
