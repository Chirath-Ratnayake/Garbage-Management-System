...
<div style="display: none" id="form">
    <table class="map1">
        <tr>
            ...
            <td><a>Remark:</a></td>
            <td><textarea disabled id='remark' placeholder='remark'></textarea></td>
        </tr>
        <tr>
...
<script async defer
        src="https://maps.googleapis.com/maps/api/js?language=en&key=AIzaSyDbEHaIJdMmORdjhrlO7bBeaoJx1hPt3BU&callback=initMap">
</script>